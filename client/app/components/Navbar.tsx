...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-40 bg-black bg-opacity-70 backdrop-blur-lg shadow-md">
            ...
            <ul className="flex space-x-8 text-lg items-center">
              ...
              <li>
                <button 
                  ...
                  className="text-white transition-all duration-300 hover:text-indigo-400 hover:scale-105 flex items-center"
